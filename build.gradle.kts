...
subprojects {
    ...
    tasks.withType<io.gitlab.arturbosch.detekt.Detekt>().configureEach {
        ...
        // NOTE: detekt 1.23.8 cannot read a JDK 25 version string — it fails
        // with a bare "25.0.3". It analyses in the Gradle daemon's own JVM and
        // 1.23 has no way to fork, so there is nothing to configure here: run
        // the build on 21 or 23 to lint. CI skips these two tasks on its Java
        // 25 job for the same reason, and says so there.
    }
