...
Three of the items below have been acted on — two of them finished, one of them
partly — and the page says so here rather than being quietly rewritten, because
the argument for the order is worth keeping next to the result of following it.
