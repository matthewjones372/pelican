...
/**
 * What every generating task needs: a class to load, a function to call, and
 * the classpath to do both against.
 *
...
abstract class GenerateKotlinClientTask : PelicanTask() {
...
abstract class CheckKotlinClientTask : PelicanTask() {
...
abstract class GenerateDocumentTask : PelicanTask() {
