...
All twenty-two modules are on Maven Central under `io.github.matthewjones372`,
...
| [Modules](docs/modules.md) | What each of the twenty-two modules is for and what it depends on, for deciding which ones your build needs. |
